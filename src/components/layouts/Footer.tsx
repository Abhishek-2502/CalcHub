      ...
      <Container>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://linkedin.com/in/abhishek--rajput" className="text-muted-foreground hover:text-[#1DA1F2]">
                <Linkedin className="h-5 w-5" />
                <span className="sr-only">Linkedin</span>
              </a>
              <a href="https://github.com/Abhishek-2502/CalcHub" className="text-muted-foreground dark:hover:text-[#f6f6f7] hover:text-[#000000]">
        ...
        <div className="mt-8 border-t border-border/40 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Abhishek Rajput. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground flex items-center mt-2 md:mt-0">
            Made with <Heart className="h-4 w-4 mx-1 text-red-500" /> for Abhishek Rajput
          </p>
        </div>
      </Container>
    </footer>
