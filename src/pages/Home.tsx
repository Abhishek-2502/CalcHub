  ...
  const testimonials = [
    {
      ...
      rating: 4,
      comment: 'As a financial analyst, accuracy matters to me. CalcHub saves me hours by handling both simple and complex calculations without errors.'
    },
    {
      id: 2,
      name: 'Priya Patel',
      ...
      rating: 5,
      comment: 'CalcHub has made my math solution so much easier! I don’t waste time searching for different calculators anymore — everything is in one place.'
    },
    {
      id: 3,
      name: 'Rohit Kumar',
      ...
      rating: 5,
      comment: 'Accurate and fast. CalcHub saves hours of work by simplifying both financial and complex calculations.'
    },
    {
      id: 4,
      name: 'Sneha Reddy',
  ...
  return (
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg font-satoshi md:text-xl mb-8 text-white/90 leading-relaxed">
              Start With <span className="text-white/60 font-supreme">CalcHub </span> Today.
            </p>
            <Link
    ...
    <Card className="max-w-md w-full text-center border border-indigo-300 dark:border-indigo-800 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl">
      ...
      <CardDescription className="text-sm font-satoshi text-gray-600 dark:text-gray-400">
       ...
       <CardContent>
      <a
        href="mailto:abhishek25022004@gmail.com?subject=My%20CalcHub%20Testimonial&body=Hi%20CalcHub%20Team%2C%0D%0A%0D%0AHere%20is%20my%20testimonial%3A%0D%0A"
