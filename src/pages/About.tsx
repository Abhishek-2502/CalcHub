          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 font-satoshi max-w-xl mx-auto">
                ...
                CalcHub is always evolving with your feedback. Your input helps us build better tools for everyone.
              </p>
              <div className="flex justify-center gap-4">
                <a
                  href="mailto:abhishek25022004@gmail.com"
                  className="px-5 py-2 rounded-lg bg-primary text-white flex items-center gap-2 hover:opacity-60 transition font-bold"
                >
                ...
                <a
                  href="/contact"
                  className="px-5 py-2 rounded-lg border border-primary text-primary flex items-center gap-2 hover:bg-primary hover:text-white transition font-bold"
                >
