            ...
            <div data-aos="fade-up">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 rounded-lg bg-[#f3f2f2] dark:bg-[#11161f]">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-sans text-[#1f1f1f] dark:text-[#ffffff]">abhishek25022004@outlook.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-lg bg-[#f3f2f2] dark:bg-[#11161f]">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-sans text-[#1f1f1f] dark:text-[#ffffff]">+91 8650104541</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-lg bg-[#f3f2f2] dark:bg-[#11161f]">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-sans text-[#1f1f1f] dark:text-[#ffffff]">Pune, Maharashtra</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  <a href="https://github.com/Abhishek-2502" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[#ffffff] bg-[#2c2c2c] hover:bg-[#1d1d1d] transition">
                    <Github className="w-5 h-5" />
                  </a>
                  <a href="https://linkedin.com/in/abhishek--rajput" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[#fff] bg-[#28aaf5] hover:bg-[#235985] transition">
